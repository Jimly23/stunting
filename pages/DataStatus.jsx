    ...
    <div className='max-w-md mx-auto bg-white min-h-screen text-slate-900 pb-12 '>
      ...
      <div className='p-2 pt-5 text-justify'>
        {history.map((item, index) => (
          <div key={index} onClick={() => handleDetail(item)} className='flex items-center justify-between p-5 bg-[#5de0e6] rounded-xl text-white font-medium mb-2'>
            <p className='text-lg'>{item.history.title}</p>
